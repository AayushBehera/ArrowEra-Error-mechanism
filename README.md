...
3. **Confidence Normalization** — raw scores are mapped to a 0–98% confidence scale.
4. **Reasoning Chain** — a step-by-step explanation is generated showing what the engine observed and concluded.
5. **Ranking** — rules are ranked by total score; the top match becomes the primary diagnosis, the next 3 are alternatives.
